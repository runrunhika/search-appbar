...
import 'package:search_appbar_weather_sample/api/weather_icons.dart';
import 'package:search_appbar_weather_sample/model/weather.dart';
...
class WeatherApi {
  ...
  static Future<List<String>> searchCities({required String query}) async {
    final limit = 3;
    final url =
        'https://api.openweathermap.org/geo/1.0/direct?q=$query&limit=$limit&appid=$apiKey&lang=ja&units=metric';
